...
const InputSwitch = () => {
	...
	const svg_sun = (
		<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-brightness-high-fill ms-3" viewBox="0 0 16 16">
			<path
	...
	const svg_moon = (
		<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-moon-fill ms-3" viewBox="0 0 16 16">
	...
	useEffect(() => {
		...
		const textsAndLabels = document.querySelectorAll("label, p, h5, h6, a");
		...
		return () => {
			checboxSwitch?.removeEventListener("change", changeTheme);
		};
	}, [isDarkMode]);
